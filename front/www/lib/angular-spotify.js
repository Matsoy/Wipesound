(function (window, angular, undefined) {
  ...
  angular
    ...
    .provider('Spotify', function () {
      ...
      // les informations du profil du client
      var votre_profil;
      ...
      this.$get = ['$q', '$http', '$window', function ($q, $http, $window) {
        ...
        NgSpotify.prototype = {
          ...
          getUserPlaylists: function (options) {
            return this.api('/me/playlists', 'GET', options, null, {
              'Authorization': 'Bearer ' + this.authToken
            });
          },

          getPlaylist: function (userId, playlistId, options) {
            return this.api('/users/' + userId + '/playlists/' + playlistId, 'GET', options, null, this.authToken);
          },

          getPlaylistTracks: function (playlistId, owner, limit, offset, options) {
            if(!limit) var limit = 100;
            if(!offset) var offset = 0;
            return this.api('/users/' + owner + '/playlists/' + playlistId + '/tracks?limit='+limit+'&offset='+offset, 'GET', options, null,this._auth());
          },
           ...
           */
           ...
           getVotre_profil: function () {
             return votre_profil;
           },

           setVotre_profil: function (data) {
             votre_profil = data;
             return votre_profil;
           },
